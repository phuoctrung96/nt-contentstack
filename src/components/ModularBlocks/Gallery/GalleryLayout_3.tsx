...
const GalleryLayout_3: React.FC<Props> = props => {
  // console.log("GalleryLayout_3: ", props)
      ...
      <div className="grid-container">
        <div className="grid-x grid-margin-x align-center">
          {props.images?.map((item, index) => {
            ...
            if (index % 3 === 1)
              return (
                <div key={`img_${index}`} className="cell small-10 large-4">
                  <GalleryImage
                    {...item}
...
GalleryLayout_3.defaultProps = defaultProps

export default GalleryLayout_3

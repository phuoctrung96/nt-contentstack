...
import { ArticlePageModel } from "../models/pages"
...
export const ArticlePage = (props: ArticlePageModel) => {
  // page data
  const page: ArticlePageModel = get(
    props,
    "data.page"
  ) as any as ArticlePageModel
  console.log("ArticlePage: ", page)
...
export const query = graphql`
  query ArticlePageByID($pageId: String!) {
